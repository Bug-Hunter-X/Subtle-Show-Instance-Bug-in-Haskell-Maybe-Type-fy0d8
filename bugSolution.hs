...
-- The solution involves using the derived instances provided by GHC.
-- This approach is generally preferred for its conciseness and avoidance of potential issues.
